    ...
    >
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-8">
          ...
          >
            {/* Vipps wordmark */}
            <svg className="h-5 w-auto flex-shrink-0" viewBox="0 0 80 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7.2 0C3.22 0 0 3.22 0 7.2v9.6C0 20.78 3.22 24 7.2 24h9.6C20.78 24 24 20.78 24 16.8V7.2C24 3.22 20.78 0 16.8 0H7.2zm4.83 5.6c.92 0 1.67.75 1.67 1.67 0 .92-.75 1.67-1.67 1.67-.92 0-1.67-.75-1.67-1.67 0-.92.75-1.67 1.67-1.67zm-4.5 3.1h2.2l1.7 4.6 2.5-4.6h2.3l-4 7.1c-.7 1.24-1.5 1.8-2.7 1.8-.6 0-1.1-.12-1.6-.36l.5-1.6c.3.13.58.2.87.2.44 0 .74-.18 1-.6l.1-.2-2.86-6.34z" fill="#fff"/>
              <path d="M31.5 17l-4.1-8.3h2.4l2.7 5.8 2.7-5.8h2.3L33.4 17h-1.9zM41.7 17.2c-2.5 0-4.3-1.7-4.3-4.3 0-2.5 1.8-4.4 4.4-4.4 2.5 0 4.3 1.8 4.3 4.3 0 2.6-1.8 4.4-4.4 4.4zm0-1.8c1.3 0 2.2-1.1 2.2-2.5 0-1.5-.9-2.6-2.2-2.6-1.3 0-2.2 1.1-2.2 2.5 0 1.5.9 2.6 2.2 2.6zM53 17.2c-1.1 0-2-.4-2.6-1.1V20h-2.1V8.7h2v1c.6-.8 1.5-1.2 2.7-1.2 2.3 0 3.9 1.8 3.9 4.3 0 2.6-1.6 4.4-3.9 4.4zm-.5-6.9c-1.3 0-2.2 1-2.2 2.5s.9 2.6 2.2 2.6c1.3 0 2.1-1 2.1-2.5s-.8-2.6-2.1-2.6zM63.6 17.2c-1.1 0-2-.4-2.6-1.1V20h-2.1V8.7h2v1c.6-.8 1.5-1.2 2.7-1.2 2.3 0 3.9 1.8 3.9 4.3 0 2.6-1.6 4.4-3.9 4.4zm-.5-6.9c-1.3 0-2.2 1-2.2 2.5s.9 2.6 2.2 2.6c1.3 0 2.1-1 2.1-2.5s-.8-2.6-2.1-2.6zM71.4 17.2c-1.8 0-3.3-.7-4-2l1.6-1c.5.8 1.3 1.2 2.4 1.2 1 0 1.5-.4 1.5-.9 0-.6-.7-.8-2-.1-1.8-.4-3-.1-3-2.4 0-1.7 1.4-2.8 3.4-2.8 1.6 0 2.9.6 3.6 1.8l-1.6.9c-.4-.7-1.1-1-2-1-.8 0-1.3.3-1.3.8 0 .6.6.7 1.9 1 1.9.4 3.1 1 3.1 2.6 0 1.8-1.5 2.9-3.6 2.9z" fill="#fff"/>
            </svg>
            Fortsett med Vipps
          </button>
